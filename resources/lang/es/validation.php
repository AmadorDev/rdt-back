...
return [
    ...
    'attributes'           => [
        ...
        'tranlations.0.name' =>'nombre en español',
        'tranlations.1.name' =>'nombre en ingles',
        'tranlations.0.description' =>'descripción en español',
        'tranlations.1.description' =>'descripción en ingles',
        'linea_id'=>'linea id',
        'date_event'=>'fecha del evento',
        'photo'=>'imagen',
        'tranlations.0.title'=>'titulo en español',
        'tranlations.1.title'=>'titulo en ingles',
        'tranlations.0.content'=>'contenido en español',
        'tranlations.1.content'=>'contenido en ingles',
        'photo.0'=>'Imagen',
        'city'=>'cuidad',
        'country'=>'país',
        'addres'=>'dirección',
