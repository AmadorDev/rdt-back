...
export default {
  ...
  methods: {
    ...
    destroy() {
      this.$inertia.delete(route("event.destroy", this.event.id), {
        onError: (errors) => {
          cuteAlert({
            type: "error",
            title: "Error",
  ...
  watch: {
    form: {
      ...
      handler: throttle(function () {
        this.$inertia.get(route("event"), this.form, {
          preserveState: true,
        });
      }, 250),
    },
